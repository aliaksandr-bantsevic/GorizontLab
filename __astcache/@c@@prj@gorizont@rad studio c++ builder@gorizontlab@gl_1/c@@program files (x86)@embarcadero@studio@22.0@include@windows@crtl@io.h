...
int  _RTLENTRY _EXPFUNC _dup2  (int __oldhandle, int __newhandle);
...
#if defined (_INTEGRAL_MAX_BITS) && (_INTEGRAL_MAX_BITS >= 64) && !defined(__STDC__)
long _RTLENTRY _EXPFUNC _wfindfirsti64(const wchar_t *, struct _wfinddatai64_t *);
long _RTLENTRY _EXPFUNC _wfindnexti64(long, struct _wfinddatai64_t *);
long _RTLENTRY _EXPFUNC _findfirsti64(const char *, struct _finddatai64_t *);
long _RTLENTRY _EXPFUNC _findnexti64(long, struct _finddatai64_t *);
#endif /* _INTEGRAL_MAX_BITS */

long _RTLENTRY _EXPFUNC __wfindfirst(const wchar_t *, struct _wfinddata_t *);
long _RTLENTRY _EXPFUNC __wfindnext(long, struct _wfinddata_t *);
long _RTLENTRY _EXPFUNC _findfirst(const char *, struct _finddata_t *);
...
intptr_t _RTLENTRY  _EXPFUNC _get_osfhandle(int __handle);
...
#if defined(__cplusplus) && !defined(__XUSING_CNAME__) && !defined(__IO_H_USING_LIST)
